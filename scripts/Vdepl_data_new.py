...
class Vdepl:
    ...
    def fit_gConstants(self, dir_out):
        ...
        fl_aver_mods = {
            ...
            "mod2": 0.0849352178077, 
            "mod3": 0.0807983035748, 
            "mod4": 0.0769244261551
        }
        ...
        fl_aver_mods_err = {
            ...
            "mod2": 0.00139773261582,
            "mod3": 0.00153435147896,
            "mod4": 0.00177183515082,
        }
        z_arr_dict = {
            "mod1":3.35,
            "mod2":10.05,
...
def main(options, args):
    ...
    # date_vdepl_dict_add = input_data
    ...
    for my_date in my_dates:
        input_data = dict()
        dir_out = "r_vs_z_full/onelinefit_%s"%(my_date.split(' ')[0].replace('-','_'))
        for modx in mod_names:
            input_data[modx] = dict()
            vdepl_input_file[modx] = open("%s/pdfs_%s/vdepl_values_%s.txt"%(parent_input_dir,modx,modx))
            input_lines = vdepl_input_file[modx].readlines()
        ...
        print(str(input_data))
        myVdepl.get_vdepl_additional(input_data["mod1"], tag=mykeys[chooseKeys], modx = "mod1")
        myVdepl.get_vdepl_additional(input_data["mod2"], tag=mykeys[chooseKeys], modx = "mod2")
        myVdepl.get_vdepl_additional(input_data["mod3"], tag=mykeys[chooseKeys], modx = "mod3")
